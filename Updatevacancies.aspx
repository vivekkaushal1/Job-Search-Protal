<%@ Page Language="C#" MasterPageFile="~/EmpMasterPage.master" AutoEventWireup="true" CodeFile="Updatevacancies.aspx.cs" Inherits="Updatevacancies" Title="Untitled Page" %>
    ...
    <tr>
      ...
      <td><asp:RequiredFieldValidator ID="reqfld" runat="server" ControlToValidate="txtFieldName" Display="Dynamic" 
          ...
          <asp:RegularExpressionValidator ID="RegFieldName" runat="server" 
               ...
               ErrorMessage="Enter a valid Characters " ValidationExpression="[a-zA-Z\s._^%$#!~@,-]+">Enter a valid Characters</asp:RegularExpressionValidator>
      </td>
    </tr>
