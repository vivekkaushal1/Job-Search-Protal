<%@ Page Language="C#" MasterPageFile="~/Iseek_MasterPage.master" AutoEventWireup="true" CodeFile="Viewexp.aspx.cs" Inherits="Viewexp" Title="Untitled Page" %>
      ...
      <td>     
        <p align="right"> 
            ...
            <asp:Button ID="btnback" runat="server" Text="Back" 
                style="height: 26px" onclick="btnback_Click" />
        </p>
      </td>
     </tr>
   </table>
