<%@ Page Language="C#" MasterPageFile="~/Iseek_MasterPage.master" AutoEventWireup="true" CodeFile="Vacancy.aspx.cs" Inherits="Vacancy" Title="Untitled Page" %>
...
<%--vacancy--%>
  ...
  <%--experience--%>
    ...
    <tr>
     ...
     <td><asp:TextBox ID="txtabtcmp" runat="server" MaxLength="150"></asp:TextBox></td>
     <td><asp:RequiredFieldValidator ID="Reqabtcomp" runat="server" ControlToValidate="txtabtcomp" Display="Dynamic" 
              ErrorMessage="Specify skills needed">*</asp:RequiredFieldValidator>
     </td>
    </tr>
