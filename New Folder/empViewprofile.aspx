<%@ Page Language="C#" MasterPageFile="~/Iseek_MasterPage.master" AutoEventWireup="true" CodeFile="empViewprofile.aspx.cs" Inherits="empViewprofile" Title="Untitled Page" %>
...
<%--website--%>
 ...
 <table align="right">
   <tr>
      ...
      <td>
        <asp:Button ID="btnupdate" align="right" runat="server" Text="Updatet" 
