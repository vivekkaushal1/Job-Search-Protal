<%@ Page Language="C#" MasterPageFile="~/Iseek_MasterPage.master" AutoEventWireup="true" CodeFile="Signup_Edu.aspx.cs" Inherits="Signup_Edu" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table align="right">
      <tr> 
       <td>
         <p align="center">
             <asp:Button ID="btneduSave" runat="server" Text="Save&Proceed" 
                 onclick="btneduSave_Click" />
         </p>
         </td>
         <td>
          <p align="center">
